...
#define SDC_CS   (*((volatile unsigned long *)0x40004020))  
...
void SSI0_Init(unsigned long CPSDVSR){
  ...
  GPIO_PORTA_DIR_R |= 0x48;             // PA6,PA3 output (CS to LCD)
  //GPIO_PORTA_DATA_R |= 0x08;            // PA7,PA3 high (disable LCD)
  
  GPIO_PORTA_DR4R_R |= 0x48;            // 4mA output on outputs
